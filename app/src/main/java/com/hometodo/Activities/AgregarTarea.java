...
public class AgregarTarea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_agregarTarea = findViewById(R.id.btn_agregarTarea);
        ...
        btn_agregarTarea.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(validarCampos()){
                    ...
                    Homework hw=new Homework(materia,descripcion,titulo,fecha,false);

                    if(hw.save(getApplicationContext())){
    ...
    private void calendarioHoraEntrega() {
        ...
        txt_hora.getEditText().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(AgregarTarea.this);
