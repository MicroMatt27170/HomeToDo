...
public class Perfil extends Activity {
    ...
    private String[] permissions = new String[]{Manifest.permission.ACCESS_FINE_LOCATION,Manifest.permission.ACCESS_COARSE_LOCATION,Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            txtNombre.getEditText().setText(shared.getString("nombre",""));
            txtApellidos.getEditText().setText(shared.getString("apellido",""));
            txtAlias.getEditText().setText(shared.getString("alias",""));
            txtCarrera.getEditText().setText(shared.getString("carrera",""));
            txtSemestre.getEditText().setText(shared.getString("semestre",""));
