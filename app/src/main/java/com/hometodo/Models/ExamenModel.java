...
public class ExamenModel implements Parcelable {
    public ExamenModel(){
    }
    ...
    public static final Creator<ExamenModel> CREATOR = new Creator<ExamenModel>() {
        @Override
        public ExamenModel createFromParcel(Parcel in) {
            return new ExamenModel(in);
        }

        @Override
        public ExamenModel[] newArray(int size) {
            return new ExamenModel[size];
        }
    };
